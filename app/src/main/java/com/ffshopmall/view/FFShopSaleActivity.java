...
//        getBean(bundle.getString("shopId"));
...
//                FFIndoorGuideShop guideShopFragment = new FFIndoorGuideShop();
                Intent intent = new Intent(FFShopSaleActivity.this, FFIndoorGuideShop.class);
                Bundle bundle = new Bundle();
        ...
        try{
            ...
            if (response.getStatusLine().getStatusCode() == 200) { //200表示请求成功
                ...
                if (entity != null) {
                    ...
                    shopbean.setShopImage(jsonObject.getString("shopImage"));
                    shopbean.setShopLogo(jsonObject.getString("shopLogo"));
